...
def get_lora_config(distill_conf:dict):
    lora_config = LoraConfig(
        r= int(distill_conf['lora_rank']),
        lora_alpha=int(distill_conf['lora_alpha']),
        target_modules=distill_conf['lora_target_modules'],
        lora_dropout=float(distill_conf['lora_dropout']),
        bias="none",
        task_type="CAUSAL_LM"
    )
    return lora_config
...
def do_distill_wb_lora(distill_conf:dict):
    ...
    lora_config = get_lora_config(distill_conf)
